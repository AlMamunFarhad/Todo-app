...
//  number1>number2 ? console.log(number1) :  number1>number3 ? console.log(number1) : number2>number1 ? console.log(number2) :  number2>number3 ? console.log(number2): number3>number1? console.log(number3): number3;
